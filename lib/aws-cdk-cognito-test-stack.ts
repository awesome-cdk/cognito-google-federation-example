...
export class AwsCdkCognitoTestStack extends Stack {
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        new UserPoolIdentityProviderGoogle(this, "Google", {
            ...
            clientId:
                "727537661772-gvsqml5fj15odn7i9ut3q0std5a9fko2.apps.googleusercontent.com",
        ...
        const cognitoUserPoolsAuthorizer = new CognitoUserPoolsAuthorizer(
            this,
        ...
        const callbackUrl = restApi.urlForPath("/public");
        ...
        new StringParameter(this, "UserPoolClientSecret", {
            ...
            stringValue: describeCognitoUserPoolClient.getResponseField(
        ...
        restApi.root.resourceForPath("/auth/login").addMethod(
            "GET",
            new LambdaIntegration(
                new NodejsFunction(this, "NodejsFunction/login", {
        ...
        restApi.root.resourceForPath("/auth/callback").addMethod(
            "GET",
            new LambdaIntegration(
                new NodejsFunction(this, "NodejsFunction/callback", {
        ...
        restApi.root.resourceForPath("/user").addMethod(
            "GET",
            new LambdaIntegration(
                new NodejsFunction(this, "NodejsFunction/getUser", {
        ...
        restApi.root.resourceForPath("public").addMethod(
            "ANY",
            new LambdaIntegration(
                new NodejsFunction(this, "NodejsFunction/public", {
                    entry: path.resolve(__dirname, "api/lambda/public.lambda.ts"),
                    bundling: {
                        nodeModules: ["ejs"],
                        commandHooks: {
